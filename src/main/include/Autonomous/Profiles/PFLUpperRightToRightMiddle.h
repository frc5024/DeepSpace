#ifndef _PFLUPPERRIGHTORIGHTMIDDLE_HG_
#define _PFLUPPERRIGHTORIGHTMIDDLE_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHUpperRightToRightMiddle.h"

/**
 *
 */
class PFLUpperRightToRightMiddle
{
public:
	PFLUpperRightToRightMiddle(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
