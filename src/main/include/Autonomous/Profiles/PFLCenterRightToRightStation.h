#ifndef _PFLCENTERRIGHTTORIGHTSTATION_HG_
#define _PFLCENTERRIGHTTORIGHTSTATION_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHCenterRightToRightStation.h"

/**
 *
 */
class PFLCenterRightToRightStation
{
public:
	PFLCenterRightToRightStation(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
