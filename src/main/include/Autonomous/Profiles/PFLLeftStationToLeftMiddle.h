#ifndef _PFLLEFTSTATIONTOLEFTMIDDLE_HG_
#define _PFLLEFTSTATIONTOLEFTMIDDLE_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHLeftStationToLeftMiddle.h"

/**
 *
 */
class PFLLeftStationToLeftMiddle
{
public:
	PFLLeftStationToLeftMiddle(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
