#ifndef _PFLJUSTDRIVEFORWARD_HG_
#define _PFLJUSTDRIVEFORWARD_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHJustDriveForward.h"
...
{
public:
	PFLJustDriveForward(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
