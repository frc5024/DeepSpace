#ifndef _PFLUPPERLEFTTOLEFTFRONT_HG_
#define _PFLUPPERLEFTTOLEFTFRONT_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHUpperLeftToLeftFront.h"

/**
 *
 */
class PFLUpperLeftToLeftFront
{
public:
	PFLUpperLeftToLeftFront(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
