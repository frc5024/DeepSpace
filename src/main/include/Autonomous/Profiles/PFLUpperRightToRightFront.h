#ifndef _PFLUPPERRIGHTTORIGHTFRONT_HG_
#define _PFLUPPERRIGHTTORIGHTFRONT_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHUpperRightToRightFront.h"

/**
 *
 */
class PFLUpperRightToRightFront
{
public:
	PFLUpperRightToRightFront(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
