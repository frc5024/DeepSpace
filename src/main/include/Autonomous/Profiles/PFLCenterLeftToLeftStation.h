#ifndef _PFLCENTERLEFTTOLEFTSTATION_HG_
#define _PFLCENTERLEFTTOLEFTSTATION_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHCenterLeftToLeftStation.h"

/**
 *
 */
class PFLCenterLeftToLeftStation
{
public:
	PFLCenterLeftToLeftStation(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
