#ifndef _PFLRIGHTBACKTORIGHTSTATION_HG_
#define _PFLRIGHTBACKTORIGHTSTATION_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHRightBackToRightStation.h"

/**
 *
 */
class PFLRightBackToRightStation
{
public:
	PFLRightBackToRightStation(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
