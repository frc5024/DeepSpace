#ifndef _PFLLEFTBACKTOLEFTSTATION_HG_
#define _PFLLEFTBACKTOLEFTSTATION_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHLeftBackToLeftStation.h"

/**
 *
 */
class PFLLeftBackToLeftStation
{
public:
	PFLLeftBackToLeftStation(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
