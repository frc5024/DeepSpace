#ifndef _PFLUPPERLEFTTOLEFTMIDDLE_HG_
#define _PFLUPPERLEFTTOLEFTMIDDLE_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHUpperLeftToLeftMiddle.h"

/**
 *
 */
class PFLUpperLeftToLeftMiddle
{
public:
	PFLUpperLeftToLeftMiddle(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
