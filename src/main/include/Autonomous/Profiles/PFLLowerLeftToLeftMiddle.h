#ifndef _PFLOWERLEFTTOLEFTMIDDLE_HG_
#define _PFLOWERLEFTTOLEFTMIDDLE_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHLowerLeftToLeftMiddle.h"

/**
 *
 */
class PFLLowerLeftToLeftMiddle
{
public:
	PFLLowerLeftToLeftMiddle(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
