#ifndef _PFLCENTERTOFRONTLEFT_HG_
#define _PFLCENTERTOFRONTLEFT_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHCenterToFrontLeft.h"

/**
 *
 */
class PFLCenterToFrontLeft
{
public:
	PFLCenterToFrontLeft(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
