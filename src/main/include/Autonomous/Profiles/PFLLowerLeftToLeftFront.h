#ifndef _PFLLOWERLEFTTOLEFTFRONT_HG_
#define _PFLLOWERLEFTTOLEFTFRONT_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHLowerLeftToLeftFront.h"

/**
 *
 */
class PFLLowerLeftToLeftFront
{
public:
	PFLLowerLeftToLeftFront(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
