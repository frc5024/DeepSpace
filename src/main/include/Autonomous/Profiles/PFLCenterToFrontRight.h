#ifndef _PFLCENTERTOFRONTRIGHT_HG_
#define _PFLCENTERTOFRONTRIGHT_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHCenterToFrontRight.h"

/**
 *
 */
class PFLCenterToFrontRight
{
public:
	PFLCenterToFrontRight(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
