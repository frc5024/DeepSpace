#ifndef _PFLRIGHTSTATIONTORIGHTMIDDLE_HG_
#define _PFLRIGHTSTATIONTORIGHTMIDDLE_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHRightStationToRightMiddle.h"

/**
 *
 */
class PFLRightStationToRightMiddle
{
public:
	PFLRightStationToRightMiddle(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
