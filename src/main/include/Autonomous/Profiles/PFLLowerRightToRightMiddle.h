#ifndef _PFLLOWERRIGHTTORIGHTMIDDLE_HG_
#define _PFLLOWERRIGHTTORIGHTMIDDLE_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHLowerRightToRightMiddle.h"

/**
 *
 */
class PFLLowerRightToRightMiddle
{
public:
	PFLLowerRightToRightMiddle(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
