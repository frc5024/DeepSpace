#ifndef _PFLUPPERRIGHTTORIGHTBACK_HG_
#define _PFLUPPERRIGHTTORIGHTBACK_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHUpperRightToRightBack.h"

/**
 *
 */
class PFLUpperRightToRightBack
{
public:
	PFLUpperRightToRightBack(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
