#ifndef _PFLLOWERRIGHTTORIGHTFRONT_HG_
#define _PFLLOWERRIGHTTORIGHTFRONT_HG_

#include <frc/WPILib.h>
#include <ctre/Phoenix.h>
#include "Autonomous/Instrumentation.h"

#include "Autonomous/Paths/PTHLowerRightToRightFront.h"

/**
 *
 */
class PFLLowerRightToRightFront
{
public:
	PFLLowerRightToRightFront(can::WPI_TalonSRX & leftTalon, can::WPI_TalonSRX & rightTalon);
