#ifndef _INTERFACES_ESC_H
#define _INTERFACES_ESC_H
...
namespace ESC{
    ...
    // class TalonSRX : public can::WPI_TalonSRX {
    //     public:
    //         /**
    ...
    //         void InitEncodingMode();
    //         void InitEncodingMode(bool phase = true);
    //         int GetPosition();
    // };

    class TalonSRX : public frc::SpeedController, public encoder {
        public:
            ...
            // TalonSRX(int port);
            explicit TalonSRX(int port);
            TalonSRX(TalonSRX &&) = default;
            TalonSRX& operator=(TalonSRX&&) = default;
            // ~TalonSRX();
    ...
    struct encoded_motor {
        frc::SpeedController  *motor;
        encoder               *sensor;
    };
}

#endif // _INTERFACES_ESC_H