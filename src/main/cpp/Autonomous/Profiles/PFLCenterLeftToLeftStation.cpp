 ...
 *
 */
PFLCenterLeftToLeftStation::PFLCenterLeftToLeftStation(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLCenterLeftToLeftStation::PeriodicTask, this)
{
 ...
 *
 */
void PFLCenterLeftToLeftStation::PeriodicTask()
{
 ...
 *
 */
void PFLCenterLeftToLeftStation::reset()
{
 ...
 * Called every loop.
 */
void PFLCenterLeftToLeftStation::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLCenterLeftToLeftStation::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLCenterLeftToLeftStation::startFilling()
{
	startFilling(kCenterLeftToLeftStationLeft, kCenterLeftToLeftStationRight, kCenterLeftToLeftStationSz);
}

/**
 *
 */
bool PFLCenterLeftToLeftStation::isFinished()
{
 ...
 *
 */
void PFLCenterLeftToLeftStation::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLCenterLeftToLeftStation::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLCenterLeftToLeftStation::getSetValue()
{
	return _setValue;
}
