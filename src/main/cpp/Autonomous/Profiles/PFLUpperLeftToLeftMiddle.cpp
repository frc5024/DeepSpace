 ...
 *
 */
PFLUpperLeftToLeftMiddle::PFLUpperLeftToLeftMiddle(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLUpperLeftToLeftMiddle::PeriodicTask, this)
{
 ...
 *
 */
void PFLUpperLeftToLeftMiddle::PeriodicTask()
{
 ...
 *
 */
void PFLUpperLeftToLeftMiddle::reset()
{
 ...
 * Called every loop.
 */
void PFLUpperLeftToLeftMiddle::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLUpperLeftToLeftMiddle::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLUpperLeftToLeftMiddle::startFilling()
{
	startFilling(kUpperLeftToLeftMiddleLeft, kUpperLeftToLeftMiddleRight, kUpperLeftToLeftMiddleSz);
}

/**
 *
 */
bool PFLUpperLeftToLeftMiddle::isFinished()
{
 ...
 *
 */
void PFLUpperLeftToLeftMiddle::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLUpperLeftToLeftMiddle::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLUpperLeftToLeftMiddle::getSetValue()
{
	return _setValue;
}
