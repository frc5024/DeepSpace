 ...
 *
 */
PFLJustDriveForward::PFLJustDriveForward(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLJustDriveForward::PeriodicTask, this)
{
 ...
 *
 */
void PFLJustDriveForward::PeriodicTask()
{
 ...
 *
 */
void PFLJustDriveForward::reset()
{
 ...
 * Called every loop.
 */
void PFLJustDriveForward::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLJustDriveForward::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLJustDriveForward::startFilling()
{
	startFilling(kJustDriveForwardLeft, kJustDriveForwardRight, kJustDriveForwardSz);
}

/**
 *
 */
bool PFLJustDriveForward::isFinished()
{
 ...
 *
 */
void PFLJustDriveForward::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLJustDriveForward::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLJustDriveForward::getSetValue()
{
	return _setValue;
}
