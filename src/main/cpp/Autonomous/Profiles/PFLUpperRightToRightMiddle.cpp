 ...
 *
 */
PFLUpperRightToRightMiddle::PFLUpperRightToRightMiddle(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLUpperRightToRightMiddle::PeriodicTask, this)
{
 ...
 *
 */
void PFLUpperRightToRightMiddle::PeriodicTask()
{
 ...
 *
 */
void PFLUpperRightToRightMiddle::reset()
{
 ...
 * Called every loop.
 */
void PFLUpperRightToRightMiddle::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLUpperRightToRightMiddle::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLUpperRightToRightMiddle::startFilling()
{
	startFilling(kUpperRightToRightMiddleLeft, kUpperRightToRightMiddleRight, kUpperRightToRightMiddleSz);
}

/**
 *
 */
bool PFLUpperRightToRightMiddle::isFinished()
{
 ...
 *
 */
void PFLUpperRightToRightMiddle::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLUpperRightToRightMiddle::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLUpperRightToRightMiddle::getSetValue()
{
	return _setValue;
}
