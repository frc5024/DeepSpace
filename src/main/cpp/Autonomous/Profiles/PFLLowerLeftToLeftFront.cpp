 ...
 *
 */
PFLLowerLeftToLeftFront::PFLLowerLeftToLeftFront(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLLowerLeftToLeftFront::PeriodicTask, this)
{
 ...
 *
 */
void PFLLowerLeftToLeftFront::PeriodicTask()
{
 ...
 *
 */
void PFLLowerLeftToLeftFront::reset()
{
 ...
 * Called every loop.
 */
void PFLLowerLeftToLeftFront::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLLowerLeftToLeftFront::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLLowerLeftToLeftFront::startFilling()
{
	startFilling(kLowerLeftToLeftFrontLeft, kLowerLeftToLeftFrontRight, kLowerLeftToLeftFrontSz);
}

/**
 *
 */
bool PFLLowerLeftToLeftFront::isFinished()
{
 ...
 *
 */
void PFLLowerLeftToLeftFront::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLLowerLeftToLeftFront::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLLowerLeftToLeftFront::getSetValue()
{
	return _setValue;
}
