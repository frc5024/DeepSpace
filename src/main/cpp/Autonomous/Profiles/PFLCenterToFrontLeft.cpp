 ...
 *
 */
PFLCenterToFrontLeft::PFLCenterToFrontLeft(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLCenterToFrontLeft::PeriodicTask, this)
{
 ...
 *
 */
void PFLCenterToFrontLeft::PeriodicTask()
{
 ...
 *
 */
void PFLCenterToFrontLeft::reset()
{
 ...
 * Called every loop.
 */
void PFLCenterToFrontLeft::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLCenterToFrontLeft::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLCenterToFrontLeft::startFilling()
{
	startFilling(kCenterToFrontLeftLeft, kCenterToFrontLeftRight, kCenterToFrontLeftSz);
}

/**
 *
 */
bool PFLCenterToFrontLeft::isFinished()
{
 ...
 *
 */
void PFLCenterToFrontLeft::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLCenterToFrontLeft::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLCenterToFrontLeft::getSetValue()
{
	return _setValue;
}
