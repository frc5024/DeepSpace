 ...
 *
 */
PFLUpperRightToRightBack::PFLUpperRightToRightBack(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLUpperRightToRightBack::PeriodicTask, this)
{
 ...
 *
 */
void PFLUpperRightToRightBack::PeriodicTask()
{
 ...
 *
 */
void PFLUpperRightToRightBack::reset()
{
 ...
 * Called every loop.
 */
void PFLUpperRightToRightBack::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLUpperRightToRightBack::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLUpperRightToRightBack::startFilling()
{
	startFilling(kUpperRightToRightBackLeft, kUpperRightToRightBackRight, kUpperRightToRightBackSz);
}

/**
 *
 */
bool PFLUpperRightToRightBack::isFinished()
{
 ...
 *
 */
void PFLUpperRightToRightBack::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLUpperRightToRightBack::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLUpperRightToRightBack::getSetValue()
{
	return _setValue;
}
