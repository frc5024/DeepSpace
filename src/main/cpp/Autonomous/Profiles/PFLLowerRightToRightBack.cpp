 ...
 *
 */
PFLLowerRightToRightBack::PFLLowerRightToRightBack(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLLowerRightToRightBack::PeriodicTask, this)
{
 ...
 *
 */
void PFLLowerRightToRightBack::PeriodicTask()
{
 ...
 *
 */
void PFLLowerRightToRightBack::reset()
{
 ...
 * Called every loop.
 */
void PFLLowerRightToRightBack::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLLowerRightToRightBack::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLLowerRightToRightBack::startFilling()
{
	startFilling(kLowerRightToRightBackLeft, kLowerRightToRightBackRight, kLowerRightToRightBackSz);
}

/**
 *
 */
bool PFLLowerRightToRightBack::isFinished()
{
 ...
 *
 */
void PFLLowerRightToRightBack::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLLowerRightToRightBack::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLLowerRightToRightBack::getSetValue()
{
	return _setValue;
}
