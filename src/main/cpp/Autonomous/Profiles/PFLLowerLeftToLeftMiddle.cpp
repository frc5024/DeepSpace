 ...
 *
 */
PFLLowerLeftToLeftMiddle::PFLLowerLeftToLeftMiddle(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLLowerLeftToLeftMiddle::PeriodicTask, this)
{
 ...
 *
 */
void PFLLowerLeftToLeftMiddle::PeriodicTask()
{
 ...
 *
 */
void PFLLowerLeftToLeftMiddle::reset()
{
 ...
 * Called every loop.
 */
void PFLLowerLeftToLeftMiddle::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLLowerLeftToLeftMiddle::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLLowerLeftToLeftMiddle::startFilling()
{
	startFilling(kLowerLeftToLeftMiddleLeft, kLowerLeftToLeftMiddleRight, kLowerLeftToLeftMiddleSz);
}

/**
 *
 */
bool PFLLowerLeftToLeftMiddle::isFinished()
{
 ...
 *
 */
void PFLLowerLeftToLeftMiddle::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLLowerLeftToLeftMiddle::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLLowerLeftToLeftMiddle::getSetValue()
{
	return _setValue;
}
