 ...
 *
 */
PFLLowerLeftToLeftBack::PFLLowerLeftToLeftBack(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLLowerLeftToLeftBack::PeriodicTask, this)
{
 ...
 *
 */
void PFLLowerLeftToLeftBack::PeriodicTask()
{
 ...
 *
 */
void PFLLowerLeftToLeftBack::reset()
{
 ...
 * Called every loop.
 */
void PFLLowerLeftToLeftBack::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLLowerLeftToLeftBack::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLLowerLeftToLeftBack::startFilling()
{
	startFilling(kLowerLeftToLeftBackLeft, kLowerLeftToLeftBackRight, kLowerLeftToLeftBackSz);
}

/**
 *
 */
bool PFLLowerLeftToLeftBack::isFinished()
{
 ...
 *
 */
void PFLLowerLeftToLeftBack::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLLowerLeftToLeftBack::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLLowerLeftToLeftBack::getSetValue()
{
	return _setValue;
}
