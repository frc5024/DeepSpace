 ...
 *
 */
PFLLeftStationToLeftMiddle::PFLLeftStationToLeftMiddle(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLLeftStationToLeftMiddle::PeriodicTask, this)
{
 ...
 *
 */
void PFLLeftStationToLeftMiddle::PeriodicTask()
{
 ...
 *
 */
void PFLLeftStationToLeftMiddle::reset()
{
 ...
 * Called every loop.
 */
void PFLLeftStationToLeftMiddle::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLLeftStationToLeftMiddle::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLLeftStationToLeftMiddle::startFilling()
{
	startFilling(kLeftStationToLeftMiddleLeft, kLeftStationToLeftMiddleRight, kLeftStationToLeftMiddleSz);
}

/**
 *
 */
bool PFLLeftStationToLeftMiddle::isFinished()
{
 ...
 *
 */
void PFLLeftStationToLeftMiddle::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLLeftStationToLeftMiddle::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLLeftStationToLeftMiddle::getSetValue()
{
	return _setValue;
}
