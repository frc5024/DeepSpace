 ...
 *
 */
PFLLowerRightToRightFront::PFLLowerRightToRightFront(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLLowerRightToRightFront::PeriodicTask, this)
{
 ...
 *
 */
void PFLLowerRightToRightFront::PeriodicTask()
{
 ...
 *
 */
void PFLLowerRightToRightFront::reset()
{
 ...
 * Called every loop.
 */
void PFLLowerRightToRightFront::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLLowerRightToRightFront::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLLowerRightToRightFront::startFilling()
{
	startFilling(kLowerRightToRightFrontLeft, kLowerRightToRightFrontRight, kLowerRightToRightFrontSz);
}

/**
 *
 */
bool PFLLowerRightToRightFront::isFinished()
{
 ...
 *
 */
void PFLLowerRightToRightFront::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLLowerRightToRightFront::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLLowerRightToRightFront::getSetValue()
{
	return _setValue;
}
