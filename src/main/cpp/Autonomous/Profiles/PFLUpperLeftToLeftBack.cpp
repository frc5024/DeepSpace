 ...
 *
 */
PFLUpperLeftToLeftBack::PFLUpperLeftToLeftBack(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLUpperLeftToLeftBack::PeriodicTask, this)
{
 ...
 *
 */
void PFLUpperLeftToLeftBack::PeriodicTask()
{
 ...
 *
 */
void PFLUpperLeftToLeftBack::reset()
{
 ...
 * Called every loop.
 */
void PFLUpperLeftToLeftBack::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLUpperLeftToLeftBack::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLUpperLeftToLeftBack::startFilling()
{
	startFilling(kUpperLeftToLeftBackLeft, kUpperLeftToLeftBackRight, kUpperLeftToLeftBackSz);
}

/**
 *
 */
bool PFLUpperLeftToLeftBack::isFinished()
{
 ...
 *
 */
void PFLUpperLeftToLeftBack::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLUpperLeftToLeftBack::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLUpperLeftToLeftBack::getSetValue()
{
	return _setValue;
}
