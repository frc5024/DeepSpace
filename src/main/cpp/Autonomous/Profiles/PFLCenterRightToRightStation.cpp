 ...
 *
 */
PFLCenterRightToRightStation::PFLCenterRightToRightStation(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLCenterRightToRightStation::PeriodicTask, this)
{
 ...
 *
 */
void PFLCenterRightToRightStation::PeriodicTask()
{
 ...
 *
 */
void PFLCenterRightToRightStation::reset()
{
 ...
 * Called every loop.
 */
void PFLCenterRightToRightStation::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLCenterRightToRightStation::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLCenterRightToRightStation::startFilling()
{
	startFilling(kCenterRightToRightStationLeft, kCenterRightToRightStationRight, kCenterRightToRightStationSz);
}

/**
 *
 */
bool PFLCenterRightToRightStation::isFinished()
{
 ...
 *
 */
void PFLCenterRightToRightStation::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLCenterRightToRightStation::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLCenterRightToRightStation::getSetValue()
{
	return _setValue;
}
