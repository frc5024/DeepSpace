 ...
 *
 */
PFLLowerRightToRightMiddle::PFLLowerRightToRightMiddle(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLLowerRightToRightMiddle::PeriodicTask, this)
{
 ...
 *
 */
void PFLLowerRightToRightMiddle::PeriodicTask()
{
 ...
 *
 */
void PFLLowerRightToRightMiddle::reset()
{
 ...
 * Called every loop.
 */
void PFLLowerRightToRightMiddle::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLLowerRightToRightMiddle::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLLowerRightToRightMiddle::startFilling()
{
	startFilling(kLowerRightToRightMiddleLeft, kLowerRightToRightMiddleRight, kLowerRightToRightMiddleSz);
}

/**
 *
 */
bool PFLLowerRightToRightMiddle::isFinished()
{
 ...
 *
 */
void PFLLowerRightToRightMiddle::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLLowerRightToRightMiddle::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLLowerRightToRightMiddle::getSetValue()
{
	return _setValue;
}
