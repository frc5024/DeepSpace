 ...
 *
 */
PFLRightBackToRightStation::PFLRightBackToRightStation(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLRightBackToRightStation::PeriodicTask, this)
{
 ...
 *
 */
void PFLRightBackToRightStation::PeriodicTask()
{
 ...
 *
 */
void PFLRightBackToRightStation::reset()
{
 ...
 * Called every loop.
 */
void PFLRightBackToRightStation::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLRightBackToRightStation::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLRightBackToRightStation::startFilling()
{
	startFilling(kRightBackToRightStationLeft, kRightBackToRightStationRight, kRightBackToRightStationSz);
}

/**
 *
 */
bool PFLRightBackToRightStation::isFinished()
{
 ...
 *
 */
void PFLRightBackToRightStation::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLRightBackToRightStation::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLRightBackToRightStation::getSetValue()
{
	return _setValue;
}
