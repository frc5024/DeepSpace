 ...
 *
 */
PFLCenterToFrontRight::PFLCenterToFrontRight(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLCenterToFrontRight::PeriodicTask, this)
{
 ...
 *
 */
void PFLCenterToFrontRight::PeriodicTask()
{
 ...
 *
 */
void PFLCenterToFrontRight::reset()
{
 ...
 * Called every loop.
 */
void PFLCenterToFrontRight::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLCenterToFrontRight::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLCenterToFrontRight::startFilling()
{
	startFilling(kCenterToFrontRightLeft, kCenterToFrontRightRight, kCenterToFrontRightSz);
}

/**
 *
 */
bool PFLCenterToFrontRight::isFinished()
{
 ...
 *
 */
void PFLCenterToFrontRight::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLCenterToFrontRight::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLCenterToFrontRight::getSetValue()
{
	return _setValue;
}
