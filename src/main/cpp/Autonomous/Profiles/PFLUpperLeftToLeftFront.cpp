 ...
 *
 */
PFLUpperLeftToLeftFront::PFLUpperLeftToLeftFront(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLUpperLeftToLeftFront::PeriodicTask, this)
{
 ...
 *
 */
void PFLUpperLeftToLeftFront::PeriodicTask()
{
 ...
 *
 */
void PFLUpperLeftToLeftFront::reset()
{
 ...
 * Called every loop.
 */
void PFLUpperLeftToLeftFront::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLUpperLeftToLeftFront::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLUpperLeftToLeftFront::startFilling()
{
	startFilling(kUpperLeftToLeftFrontLeft, kUpperLeftToLeftFrontRight, kUpperLeftToLeftFrontSz);
}

/**
 *
 */
bool PFLUpperLeftToLeftFront::isFinished()
{
 ...
 *
 */
void PFLUpperLeftToLeftFront::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLUpperLeftToLeftFront::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLUpperLeftToLeftFront::getSetValue()
{
	return _setValue;
}
