 ...
 *
 */
PFLUpperRightToRightFront::PFLUpperRightToRightFront(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLUpperRightToRightFront::PeriodicTask, this)
{
 ...
 *
 */
void PFLUpperRightToRightFront::PeriodicTask()
{
 ...
 *
 */
void PFLUpperRightToRightFront::reset()
{
 ...
 * Called every loop.
 */
void PFLUpperRightToRightFront::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLUpperRightToRightFront::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLUpperRightToRightFront::startFilling()
{
	startFilling(kUpperRightToRightFrontLeft, kUpperRightToRightFrontRight, kUpperRightToRightFrontSz);
}

/**
 *
 */
bool PFLUpperRightToRightFront::isFinished()
{
 ...
 *
 */
void PFLUpperRightToRightFront::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLUpperRightToRightFront::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLUpperRightToRightFront::getSetValue()
{
	return _setValue;
}
