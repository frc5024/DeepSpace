 ...
 *
 */
PFLRightStationToRightMiddle::PFLRightStationToRightMiddle(can::WPI_TalonSRX & talonLeft, can::WPI_TalonSRX & talonRight) : 
	_talonLeft(talonLeft), _talonRight(talonRight), _notifer(&PFLRightStationToRightMiddle::PeriodicTask, this)
{
 ...
 *
 */
void PFLRightStationToRightMiddle::PeriodicTask()
{
 ...
 *
 */
void PFLRightStationToRightMiddle::reset()
{
 ...
 * Called every loop.
 */
void PFLRightStationToRightMiddle::control()
{
	if (_loopTimeout < 0)
	{
 ...
 *
 */
int PFLRightStationToRightMiddle::GetTrajectoryDuration(int durationMs)
{
	return durationMs;
}
 ...
 *
 */
void PFLRightStationToRightMiddle::startFilling()
{
	startFilling(kRightStationToRightMiddleLeft, kRightStationToRightMiddleRight, kRightStationToRightMiddleSz);
}

/**
 *
 */
bool PFLRightStationToRightMiddle::isFinished()
{
 ...
 *
 */
void PFLRightStationToRightMiddle::startFilling(const double profileLeft[][3], const double profileRight[][3], int totalCnt)
{
 ...
 *
 */
void PFLRightStationToRightMiddle::start()
{
	_bStart = true;
}
 ...
 *
 */
SetValueMotionProfile PFLRightStationToRightMiddle::getSetValue()
{
	return _setValue;
}
